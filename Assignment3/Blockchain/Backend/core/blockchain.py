...
from Blockchain.Backend.core.Transaction import CoinbaseTx, Tx
from multiprocessing import Process, Manager
from Blockchain.Frontend.run import main
from Blockchain.Backend.core.network.syncManager import syncManager
from Blockchain.client.autoBroadcastTransaction import autoBroadcast
...
#Calculate a new target to keep mine under 20 seconds
...
class Blockchain:
  ...
  #Keep Track of all unspent Transactions in cache memory for fast retrieval
    ...
    #Check if double spending is attempted
    ...
    def read_tx_from_memorypool(self):
        self.Blocksize = 80
        self.TxIds = []
    ...
    def addBlock(self, BlockHeight, prevBlockHash):
        ...
        if competitionOver:
            ...
            self.write_on_disk(
                [Block(BlockHeight, self.Blocksize, blockheader.__dict__, len(self.TxJson), self.TxJson).__dict__]
            )
