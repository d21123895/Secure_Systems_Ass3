...
from Blockchain.Backend.util.util import (little_endian_to_int, int_to_little_endian, encode_variant, read_variant)
class Block:
    ...
    def serialise(self):
        ...
        result += encode_variant(len(self.Txs))
